...
step and captured result. Inspect the template before adapting it, and keep
secrets out of output. Do not claim the human step was run until its result is
