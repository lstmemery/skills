...
Read when performing the Standards axis, including an inline Standards-only review.
Use the exact change and standards-source list supplied by the coordinator.
...
The baseline applies even when the repository documents no standards. These Fowler
code smells (*Refactoring*, chapter 3) name the pattern and a possible repair:
