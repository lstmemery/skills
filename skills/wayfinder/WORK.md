...
Post the answer as a resolution comment, close the ticket, and append its linked title and gist to Decisions so far. For local files, use the configured equivalent. Link any result assets and evidence.
